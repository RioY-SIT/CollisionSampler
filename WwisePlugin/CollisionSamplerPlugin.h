...
class CollisionSamplerPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    CollisionSamplerPlugin();
    ~CollisionSamplerPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(CollisionSampler);	// Exposes our PluginContainer structure that contains the info for our plugin
