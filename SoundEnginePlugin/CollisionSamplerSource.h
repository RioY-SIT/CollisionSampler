...
#ifndef CollisionSamplerSource_H
#define CollisionSamplerSource_H
...
class CollisionSamplerSource
    : public AK::IAkSourcePlugin
{
public:
    CollisionSamplerSource();
    ~CollisionSamplerSource();
