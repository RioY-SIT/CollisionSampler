...
#ifndef CollisionSamplerSourceParams_H
#define CollisionSamplerSourceParams_H
...
struct CollisionSamplerRTPCParams
{
    AkReal32 fDuration;
};

struct CollisionSamplerNonRTPCParams
{
};

struct CollisionSamplerSourceParams
    : public AK::IAkPluginParam
{
    CollisionSamplerSourceParams();
    CollisionSamplerSourceParams(const CollisionSamplerSourceParams& in_rParams);
    ...
    CollisionSamplerRTPCParams RTPC;
    CollisionSamplerNonRTPCParams NonRTPC;
};

#endif // CollisionSamplerSourceParams_H
