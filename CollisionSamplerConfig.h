...
#ifndef CollisionSamplerConfig_H
#define CollisionSamplerConfig_H
...
namespace CollisionSamplerConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 21751;
}

#endif // CollisionSamplerConfig_H
