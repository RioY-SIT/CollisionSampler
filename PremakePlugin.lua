...
local Plugin = {}
Plugin.name = "CollisionSampler"
Plugin.factoryheader = "../SoundEnginePlugin/CollisionSamplerSourceFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
{
    "CollisionSamplerSourceShared.cpp"
}
...
{
    "CollisionSamplerSourceShared.cpp",
    "CollisionSamplerSourceFactory.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "CollisionSampler.def",
    "CollisionSampler.xml",
    "**.rc",
}
